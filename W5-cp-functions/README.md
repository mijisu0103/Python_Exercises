...
How to define functions, call them, import modules, and write them. For the Computer Programming module.

Use the green Code button to download, click on notebooks to see a static
version or launch as an interactive binder: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fsmeraldi/cp-functions/HEAD)
